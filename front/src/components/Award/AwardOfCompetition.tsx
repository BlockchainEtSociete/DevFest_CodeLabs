        ...
        <div>
            ...
            }
            {
                isUserAdmin( connectedUser ) && dateFinCompetition < today && !winner ?
                    atLeastOneVote ? <button className="btn-winner" onClick={ onDesignateWinnerCompetition }>Désigner le
                        gagant</button> : ''
                    : dateFinCompetition < today && winner ? <p>🎉 Le gagnant est : { winner?.title } 🎉</p> : ''
            }
            { winner &&
                <Popup open={ openDesignatedWinnerConfirmation } closeOnDocumentClick
                       onClose={ onCloseDesignatedWinnerConfirmation }>
                    <div className="modal">
                        ...
                        <div className="actions">
                            <button className="btn-reset" onClick={ onCloseDesignatedWinnerConfirmation }> Retour
                            </button>
                        </div>
                    </div>
                </Popup>
