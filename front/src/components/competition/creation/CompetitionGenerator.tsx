    ...
    return (
        <div>
            ...
            { !openCompetitionCreationForm && !openNomineesSelection && !openJurySelection &&
                <button className="btn-reset" onClick={ onEndCompetitionCreation }>Fin de la création de la
                    compétition</button>
            }

            { competitionId !== 0 &&
                <CompetitionPreview competitionId={ competitionId } setOpen={ setOpen } setMessage={ setMessage }
                                    setSeverity={ setSeverity }/>
            }
